...
// ⚠️ المسارات دي كلها "مستقلة" (flat) ومش أبناء لـ GraphicDesignRoute
// لأن كل صفحة عندها الـ header بتاعها ومفيش <Outlet /> في graphic-design.tsx
const GraphicDesignUploadRoute = GraphicDesignUploadRouteImport.update({
  id: '/graphic-design/upload',
  path: '/graphic-design/upload',
  getParentRoute: () => rootRouteImport,
} as any)
const GraphicDesignMarketRoute = GraphicDesignMarketRouteImport.update({
  id: '/graphic-design/market',
  path: '/graphic-design/market',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/graphic-design/market': typeof GraphicDesignMarketRoute
...
export interface RootRouteChildren {
  ...
  GraphicDesignMarketRoute: typeof GraphicDesignMarketRoute
...
const rootRouteChildren: RootRouteChildren = {
  ...
  GraphicDesignMarketRoute: GraphicDesignMarketRoute,
