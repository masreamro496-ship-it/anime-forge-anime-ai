...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "شاهد أنمي الآن - Shaid Anime Now" },
      { name: "description", content: "منصة توليد فيديوهات الأنمي بالذكاء الاصطناعي - Shaid Anime Now" },
      { property: "og:title", content: "شاهد أنمي الآن - Shaid Anime Now" },
      { property: "og:description", content: "منصة توليد فيديوهات الأنمي بالذكاء الاصطناعي - Shaid Anime Now" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "شاهد أنمي الآن - Shaid Anime Now" },
      { name: "twitter:description", content: "منصة توليد فيديوهات الأنمي بالذكاء الاصطناعي - Shaid Anime Now" },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9bdb01ef-92b2-41c0-905b-0f6ccf591e93/id-preview-a3b6b781--5a0fc880-1a63-436c-a3b5-8f68df7083d2.lovable.app-1779267833600.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/9bdb01ef-92b2-41c0-905b-0f6ccf591e93/id-preview-a3b6b781--5a0fc880-1a63-436c-a3b5-8f68df7083d2.lovable.app-1779267833600.png" },
