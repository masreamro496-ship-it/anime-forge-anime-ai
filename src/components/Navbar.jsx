...
const navItems = [
  ...
  { id: 'movies', label: 'أفلام', icon: Film, href: '/anime-market' },
  { id: 'anime', label: 'انمي', icon: Sparkles, href: '/anime-market' },
  { id: 'dashboard', label: 'لوحتي', icon: LayoutDashboard, href: '/dashboard' },
  { id: 'earn', label: 'اربح كريدت', icon: Gift, href: '/tasks' },
  { id: 'more', label: 'المزيد', icon: MoreHorizontal, href: '/legal' },
];
